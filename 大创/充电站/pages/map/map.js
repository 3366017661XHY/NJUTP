Page({
  ...
  processFacilities(marker) {
    const facilities = [
      { icon: 'image/hospital.png', value: marker.hospital, name: '医院' },
      { icon: 'image/mall001.png', value: marker.mall, name: '商场' },
      { icon: 'image/office.png', value: marker.office, name: '写字楼' },
      { icon: 'image/subway.png', value: marker.subway, name: '地铁' }
    ].filter(item => item.value > 0)
    
    this.setData({ facilityList: facilities })
  }
});